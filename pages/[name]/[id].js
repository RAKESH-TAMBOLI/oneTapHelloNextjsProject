...
const Profile = ({ user }) => {
    ...
    return (
        <>
            <div className='flex justify-center xs:w-full object-cover bg-slate-200 w-full h-80'>
                <img
            ...
            <div className='flex justify-center bg-slate-200'>
                ...
                <div className='-mt-32 z-10 flex justify-center xs:w-96 md:w-11/12 lg:w-11/12 '>
                    <section
                        className=' rounded-t-2xl border xs:mx-2 bg-white  w-11/12'
                        style={{ width: '500px' }}>
